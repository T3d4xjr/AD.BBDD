...
CREATE TABLE matriculas (
    ...
    año INT NOT NULL,
    estado ENUM('cursando', 'superada', 'no superada', 'cancelada') NOT NULL,
    calificacion DECIMAL(5,2),
    PRIMARY KEY (id_estudiante, id_asignatura, año),
    FOREIGN KEY (id_estudiante) REFERENCES estudiantes(id),
    FOREIGN KEY (id_asignatura) REFERENCES asignaturas(id)
);

-- Datos de ejemplo
INSERT INTO estudiantes (nombre, email, telefono, direccion) VALUES 
('Juan Pérez', 'juan.perez@mail.com', '123456789', 'Calle A, Ciudad B'),
('Ana López', 'ana.lopez@mail.com', '987654321', 'Calle X, Ciudad Y');

INSERT INTO asignaturas (nombre, curso, horas) VALUES 
('Matemáticas', 1, 120),
('Historia', 2, 90);

INSERT INTO matriculas (id_estudiante, id_asignatura, año, estado, calificacion) VALUES 
(1, 1, 2023, 'cursando', NULL),
(2, 2, 2023, 'cursando', NULL);
* 
 */
public class Menu {
